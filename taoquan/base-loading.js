...
var _LoadingHtml =  '<div id="loadingDiv" style="position:absolute;left:0;width:100%;bottom:0;height:100%;top:0;background:#eeeeee;z-index:10000;">'

    _LoadingHtml +='<div style="width:100%;height:100%;position: absolute;left:50%;margin-left:-50%;top:50%;margin-top:-20%;background:#eeeeee;">'
    ...
    _LoadingHtml +='<p style="text-align: center;padding-top:1%;color:#979797">数据加载 请稍候</p>'
